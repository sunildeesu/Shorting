...
class EODAnalyzer:
    ...
    def __init__(self):
        ...
        self.pattern_detector = EODPatternDetector(
            ...
            min_confidence=7.5,  # LOWERED from 8.0 - backtest showed 8.0 too restrictive (0 trades)
            require_confirmation=False  # DISABLED - too restrictive when combined with other filters
        )
